...
export default function EditUserModel(props) {
  ...
  useEffect(() => {
    if (success) {
      toast.success("Controller Updated Succesfully.  Redirecting...", toastOptions);
      setTimeout(() => {
        navigate("/admin/controllers");
      }, 3000);
    }
  ...
  return (
    ...
    >
      <Modal.Header>
        <Modal.Title id="contained-modal-title-vcenter">Edit Controller</Modal.Title>
      </Modal.Header>
