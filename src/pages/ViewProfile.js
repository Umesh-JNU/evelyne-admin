...
const keyProps = {
  "Email": "email", "Fullname": "fullname", "Mobile No.": "mobile_no", "City": "city", "Country": "country", "Role": "role", "Created At": "createdAt", "Last Update": "updatedAt"
};
...
const ViewProfile = () => {
  ...
  return (
    <ViewCard
      ...
      data={user && { ...user, role: user.userRole.role }}
      setModalShow={setModalShow}
      keyProps={keyProps}
      isImage="true"
      image_url={user ? user.avatar : ""}
